#pragma once
#ifndef __SYNTHFUNCTIONS_H
#define __SYNTHFUNCTIONS_H
...
enum sources{
	...
	SOURCE_BIASED_EG3,
	SOURCE_BIASED_EG4,
	SOURCE_BIASED_NOISE_GEN_EG,
	SOURCE_BIASED_FILTER_EG,
	SOURCE_VELOCITY,	
...
enum destinations{
	...
	DEST_NOISE_GEN_EG_ATTACK_SCALING,
	DEST_FILTER_EG_ATTACK_SCALING,
	DEST_ALL_EG_ATTACK_SCALING,
	DEST_EG1_DECAY_SCALING,
	DEST_EG2_DECAY_SCALING,
	DEST_EG3_DECAY_SCALING,
	DEST_EG4_DECAY_SCALING,
	DEST_NOISE_GEN_EG_DECAY_SCALING,
	DEST_FILTER_EG_DECAY_SCALING,
	...
	DEST_NOISE_GEN_EG_SUSTAIN_OVERRIDE,
	DEST_FILTER_EG_SUSTAIN_OVERRIDE,
	...
	DEST_NOISE_GEN_PULSEWIDTH,
	DEST_ALL_OSC_PULSEWIDTH,
	DEST_OSC1_FO_RATIO,
	DEST_OSC2_FO_RATIO,
	DEST_OSC3_FO_RATIO,
	DEST_OSC4_FO_RATIO,
	DEST_NOISE_GEN_FO_RATIO,
...
struct globalVoiceParams
{
	...
	double dNoiseGenEGOscModIntensity;
	double dNoiseGenEGFilter1ModIntensity;
	double dNoiseGenEGFilter2ModIntensity;
	double dNoiseGenEGDCAAmpModIntensity;

	double dFilterEGOscModIntensity;
	double dFilterEGFilter1ModIntensity;
	double dFilterEGFilter2ModIntensity;
	double dFilterEGDCAAmpModIntensity;
...
struct globalSynthParams
{
	...
	globalOscillatorParams	noiseGenParams;
	globalOscillatorParams	lfo1Params;
	...
	globalEGParams			noiseGenEGParams;
	globalEGParams			filterEGParams;
	globalDCAParams			dcaParams;
};
