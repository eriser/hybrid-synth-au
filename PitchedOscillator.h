#pragma once
#ifndef __PITCHEDOSCILLATOR_H
#define __PITCHEDOSCILLATOR_H

#include "oscillator.h"

class CPitchedOscillator : public COscillator
{
public:
	CPitchedOscillator(void);
	~CPitchedOscillator(void);
	...
	inline double doSawtooth(double dModulo, double dInc)
	{
		...
		if(m_uWaveform == SAW)			// SAW1 = normal sawtooth (ramp)
