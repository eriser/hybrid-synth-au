#pragma once
#ifndef __MODULATIONMATRIX_H
#define __MODULATIONMATRIX_H
		...
		for(int i=0; i<m_nSize; i++)
		{
			...
			switch(pRow->uDestinationIndex)
			{
				case DEST_ALL_OSC_FO:
					...
					m_dDestinations[DEST_NOISE_GEN_FO] += dModValue;
				...
				case DEST_ALL_OSC_PULSEWIDTH:
					...
					m_dDestinations[DEST_NOISE_GEN_PULSEWIDTH] += dModValue;
				...
				case DEST_ALL_OSC_FO_RATIO:
					...
					m_dDestinations[DEST_NOISE_GEN_FO_RATIO] += dModValue;
				...
				case DEST_ALL_OSC_OUTPUT_AMP:
					...
					m_dDestinations[DEST_NOISE_GEN_OUTPUT_AMP] += dModValue;
				...
				case DEST_ALL_EG_ATTACK_SCALING:
					...
					m_dDestinations[DEST_NOISE_GEN_EG_ATTACK_SCALING] += dModValue;
				...
				case DEST_ALL_EG_DECAY_SCALING:
					...
					m_dDestinations[DEST_NOISE_GEN_EG_DECAY_SCALING] += dModValue;
				...
				case DEST_ALL_EG_SUSTAIN_OVERRIDE:
					...
					m_dDestinations[DEST_NOISE_GEN_EG_SUSTAIN_OVERRIDE] += dModValue;
